...
- Attach the Linux home view with descriptor-bound `open_tree` and
  `move_mount`, and require the composed home-view plus Landlock path to run
  rather than skip in hosted acceptance.
