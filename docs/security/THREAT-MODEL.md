...
| Root-format confusion creates two stores | Strict authoritative marker, visible/dotted dual detection, newer-schema refusal and one management-held writable-layout token for every mutation |
